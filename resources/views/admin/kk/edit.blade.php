                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="no_kk" name="no_kk" class="form-control"
                                            placeholder="Nomor KK" value="{{ $kk->no_kk }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="no_kk">Tanggal Masuk</label>
                                        <input type="date" id="tanggal_masuk" name="tanggal_masuk" class="form-control"
                                            value="{{ $kk->tanggal_masuk }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Hapus" untuk Menghapus Data <br> (usahakan tidak ada No.KK yang terkait
                    dengan anggota)</div>
