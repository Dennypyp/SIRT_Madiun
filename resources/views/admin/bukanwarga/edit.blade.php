    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('bukanwarga.update', [$data->nik]) }}">
                        {{ method_field('PUT') }}
                        @csrf
                        @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col text-left">
                                    <div class="col text-left">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('bukanwarga.index') }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="/bukanwarga/destroy/{{ $data->nik }}">Hapus</a>
                </div>
            </div>
        </div>
    </div>
